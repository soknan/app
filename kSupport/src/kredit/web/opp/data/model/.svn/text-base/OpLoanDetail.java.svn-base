...
@Entity
@Table(name="OP_LOAN_DETAIL")
public class OpLoanDetail {
	...
	public OpLoan getLoan() {
		return loan;
	}

	public void setLoan(OpLoan loan) {
		this.loan = loan;
	}
	...
	public CodeItem getProduct() {
		if(product == null) {
			...
			if(product_code != null) {
				product = OperationFacade.getProduct(product_code, OpCommon.OP_PRODUCT_TYPE_LOAN);
			}
		}
		return product;
	}
