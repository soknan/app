...
public class RiskRegListVM {
	...
	public void onNew(){
		...
		String number = formatter.format(RiskRegFacade.getMaxSeq()+1);
		String tmpCode = UserCredentialManager.getIntance().getLoginUsr().getBrCd() + "-OR-"+number; 
		selected.setCode(tmpCode);
